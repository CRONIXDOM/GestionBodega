...
public class MovimientoMateriaPrimaRepositorioImpl implements IMovimientoMateriaPrimaRepositorio {
	...
	public MovimientoMateriaPrimaRepositorioImpl(IMovimientoMateriaPrimaJpaRepositorio jpaRepositorio,
	...
	public List<MovimientoMateriaPrima> buscarPorMateria(int idMateria) {
		return jpaRepositorio.findByIdMateriaOrderByFechaAscIdMovimientoAsc(idMateria).stream()
