...
public class DetalleRecetaRepositorioImpl implements IDetalleRecetaRepositorio {
    ...
    public DetalleRecetaRepositorioImpl(
            IDetalleRecetaJpaRepositorio jpaRepositorio,
    ...
    public Optional<DetalleReceta> buscarPorid(int idDetalleReceta) {
        return jpaRepositorio.findById(idDetalleReceta)
    ...
    public List<DetalleReceta> buscarPorReceta(int idReceta) {
        return jpaRepositorio.findByIdReceta(idReceta)
                .stream()
                .map(entityMapper::toDominio)
                .toList();
    }
