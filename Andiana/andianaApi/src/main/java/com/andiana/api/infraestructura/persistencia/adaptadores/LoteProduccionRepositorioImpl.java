...
public class LoteProduccionRepositorioImpl implements ILoteProduccionRepositorio {
    ...
    public LoteProduccionRepositorioImpl(
            ILoteProduccionJpaRepositorio jpaRepositorio,
    ...
    public Optional<LoteProduccion> buscarPorid(int idLoteProduccion) {
        return jpaRepositorio.findById(idLoteProduccion)
    ...
    public List<LoteProduccion> buscarPorOrden(int idOrden) {
        return jpaRepositorio.findByIdOrden(idOrden)
                .stream()
                .map(entityMapper::toDominio)
                .toList();
    }
